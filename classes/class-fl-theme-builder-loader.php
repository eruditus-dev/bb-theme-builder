...
final class FLThemeBuilderLoader {
	...
	static public function load() {
		...
		add_action( 'fl_page_data_add_properties', __CLASS__ . '::load_page_data_properties' );
		add_action( 'wp', __CLASS__ . '::load_modules', 2 );
	}
	...
	static private function define_constants() {
		define( 'FL_THEME_BUILDER_VERSION', '1.4.9.2' );
	...
	static private function load_files() {
		...
		// Theme Builder Core - if not included in BB extensions.
		// Eventually, this should be removed once BB 2.8 comes out.
		if ( ! defined( 'FL_THEME_BUILDER_CORE_DIR' ) ) {
	...
	/**
	 * Loads classes and includes for page data properties.
	 *
	 * @since 1.4.7
	 * @access public
	 * @return void
	 */
	static public function load_page_data_properties() {
